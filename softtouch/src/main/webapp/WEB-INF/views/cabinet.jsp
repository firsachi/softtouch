...
<ul class="menu">
<li class="menu-text">Відділ організаційного забезпечення діяльності Київського міського голови (патронатної служби)</li>
</ul>
</div>
<div class="top-bar-right">
<ul class="menu">
<li><a href="#">Програмне забезпечення</a></li>
<li><a href="#">Обладнання</a></li>
<li><a href="#">Профіль</a></li>
<li><a class="hollow button" href="#">Вихід</a></li>
</ul>
</div>
</div>
<!--  
...
<div class="medium-3 columns sticky-container" data-sticky-container="" style="height: 322.8px;">
